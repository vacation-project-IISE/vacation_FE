    ...
    <div>
      ...
      <div className="l-popup__buttons">
        ...
        <a className="l-popup-btn-1" href="https://brand.naver.com/monami" target="_blank">
         ...
         <a className="l-popup__button--close" onClick={(e) => e.preventDefault()} href="#">예약하기 버튼 닫기</a>
      </div>
      <div className="new">
      ...
      <div className="newarrival">
        <img src="img/zpen.jpg" className="home-zpen" alt width={392} height={205}/> 
        <img src="img/pluspen.jpg" className="home-pluspen" alt width={392} height={292} />
        <img src="img/note.jpg" className="home-note" alt width={786} height={360} />
        <img src="img/153pen.jpg" className="home-153pen" width={450} height={439} />
      ...
      <div className="p_tabs">
        <ul>
          <li className={activeCategory === "premium-pen" ? "on" : ""} onClick={() => handleCategoryChange("premium-pen")}>
            <a>프리미엄 펜</a>
          </li>
          <li className={activeCategory === "pen-pencil" ? "on" : ""} onClick={() => handleCategoryChange("pen-pencil")}>
            <a>펜-펜슬</a>
          </li>
          <li className={activeCategory === "marker-coloring" ? "on" : ""} onClick={() => handleCategoryChange("marker-coloring")}>
            <a>마카-컬러링</a>
          </li>
          <li className={activeCategory === "notebook" ? "on" : ""} onClick={() => handleCategoryChange("notebook")}>
            <a>노트-사무용품</a>
          </li>
        </ul>
      </div>
            ...
            <>
              <li>
                <a href="/product/product_view.php?idx=203&ccode=003006">
                  <div className="thum">
                    <img src="https://dfrkkcv2hg1jc.cloudfront.net/data/product/2100011114_file6_1680482799v8lz6c19ev.jpg" alt="" width={266} height={390} />
                  </div>
                  <div className="info">
              ...
              <li>
                <a href="/product/product_view.php?idx=204&ccode=003007">
                  <div className="thum">
                    <img src="https://dfrkkcv2hg1jc.cloudfront.net/data/product/2080201010_file6_1680510368gmw1j11ihk.jpg" alt="" width={266} height={390} />
                  </div>
                  <div className="info">
              ...
              <li>
                <a href="/product/product_view.php?idx=204&ccode=003007">
                  <div className="thum">
                    <img src="https://dfrkkcv2hg1jc.cloudfront.net/data/product/2040240006_file6_16255408900kpz876plz.jpg" alt="" width={266} height={390} />
                  </div>
                  <div className="info">
                    <div className="cate">수성마카</div>
              ...
              <li>
                <a href="/product/product_view.php?idx=204&ccode=003007">
                  <div className="thum">
                    <img src="https://dfrkkcv2hg1jc.cloudfront.net/data/product/2040016351_file6_16334947342g3aqx0uh1.jpg" alt="" width={266} height={390} />
                  </div>
                  <div className="info">
                    <div className="cate">수성마카</div>
              ...
              <li>
                <a href="/product/product_view.php?idx=204&ccode=003007">
                  <div className="thum">
                    <img src="https://dfrkkcv2hg1jc.cloudfront.net/data/product/2010152034_file6_1699945497e4wvhszoxy.jpg" alt="" width={266} height={390} />
                  </div>
                  <div className="info">
              ...
              <li>
                <a href="/product/product_view.php?idx=204&ccode=003007">
                  <div className="thum">
                    <img src="https://dfrkkcv2hg1jc.cloudfront.net/data/product/2041019049_file6_1659673523b6tw8za4y1.jpg" alt="" width={266} height={390} />
                  </div>
                  <div className="info">
                    <div className="cate">수성마카</div>
 ...
 {activeCategory === "marker-coloring" && (
            <>
              <li>
                <a href="/product/product_view.php?idx=203&ccode=003006">
                  <div className="thum">
                    <img src="https://dfrkkcv2hg1jc.cloudfront.net/data/product/2040002001_file6_15867537131mu8wvyj4p.jpg" alt="" width={266} height={390} />
                  </div>
                  <div className="info">
              ...
              <li>
                <a href="/product/product_view.php?idx=204&ccode=003007">
                  <div className="thum">
                    <img src="https://dfrkkcv2hg1jc.cloudfront.net/data/product/2040005001_file6_1585872127mz32ryzzpt.jpg" alt="" width={266} height={390} />
                  </div>
                  <div className="info">
                    <div className="cate">수성마카</div>
              ...
              <li>
                <a href="/product/product_view.php?idx=204&ccode=003007">
                  <div className="thum">
                    <img src="https://dfrkkcv2hg1jc.cloudfront.net/data/product/2040012004_file6_161526431756qs7ja5jo.jpg" alt="" width={266} height={390} />
                  </div>
                  <div className="info">
                    <div className="cate">수성마카</div>
              ...
              <li>
                <a href="/product/product_view.php?idx=204&ccode=003007">
                  <div className="thum">
                    <img src="https://dfrkkcv2hg1jc.cloudfront.net/data/product/2040009001_file6_1552521391bpvzh1xb2b.jpg" alt="" width={266} height={390} />
                  </div>
                  <div className="info">
          ...
          {activeCategory === "notebook" && (
            <>
              <li>
                <a href="/product/product_view.php?idx=203&ccode=003006">
                  <div className="thum">
                    <img src="https://dfrkkcv2hg1jc.cloudfront.net/data/product/2120014201_file6_1711340757johyd13i1d.jpg" alt="" width={266} height={390} />
                  </div>
                  <div className="info">
              ...
              <li>
                <a href="/product/product_view.php?idx=204&ccode=003007">
                  <div className="thum">
                    <img src="https://dfrkkcv2hg1jc.cloudfront.net/data/product/2172018015_file6_15704371548jbp9f11m5.jpg" alt="" width={266} height={390} />
                  </div>
                  <div className="info">
              ...
              <li>
                <a href="/product/product_view.php?idx=204&ccode=003007">
                  <div className="thum">
                    <img src="https://dfrkkcv2hg1jc.cloudfront.net/data/product/2172018017_file6_1570436926c8ouqp5opo.jpg" alt="" width={266} height={390} />
                  </div>
                  <div className="info">
                    <div className="cate">풀</div>
                    <div className="name">다목적으로 사용 가능한 목공풀 2-Way</div>
                  </div>
                </a>
              </li>
              <li>
                <a href="/product/product_view.php?idx=204&ccode=003007">
                  <div className="thum">
                    <img src="https://dfrkkcv2hg1jc.cloudfront.net/data/product/2172018013_file6_1570436889l87efqci2x.jpg" alt="" width={266} height={390} />
                  </div>
                  <div className="info">
                    <div className="cate">풀</div>
              ...
              <li>
                <a href="/product/product_view.php?idx=204&ccode=003007">
                  <div className="thum">
                    <img src="https://dfrkkcv2hg1jc.cloudfront.net/data/product/2172018011_file6_1570436859fjhnr74sr9.jpg" alt="" width={266} height={390} />
                  </div>
                  <div className="info">
                    <div className="cate">풀 </div>
              ...
              <li>
                <a href="/product/product_view.php?idx=204&ccode=003007">
                  <div className="thum">
                    <img src="https://dfrkkcv2hg1jc.cloudfront.net/data/product/2172018005_file6_1570436803n3uw1ntrmc.jpg" alt="" width={266} height={390} />
                  </div>
                  <div className="info">
                    <div className="cate">풀</div>
